...
@section('content')
        ...
        <div class="row">
            ...
            <div class="col-sm-8">
                <p id="fuente_bienvenidos">¡Bienvenidos al sitio web de Productos Chasm!
                    <br><br>Diseñados por jugadores, para jugadores, productos de la marca Chasm ofrecen lo mejor en diseño
                    y funcionalidad para proteger y transportar las cosas que a ti te importan.
                    <br><br>Los juegos son eventos sociales. Llevamos nuestros juegos con nosotros a nuestras reuniones y es
                    importante protegerlos.
                    <br><br>Tupperware, cajas de herramientas o cajas de zapatos simplemente no son la mejor forma para
                    transportar tus juegos.
                    <br><br> Productos Chasm brindan soluciones para proteger y transportar tus producto con seguridad y con
                    personalidad.
        ...
        <div class="row">
                ...
                <a href="_producto_interes.php" class="links_cards">
                    <div class="card card_shadow" style="width: 18rem; height: 35rem;">
                        ...
                        <div class="card-body">
                            ...
                            <p class="card-text">Las tropas Arjuna son ideales para controlar de cerca la mesa de juego,
                                aprovechar su Kiranbot sincronizado y poder aprovechar...</p>
                            <img src="{{asset('frontEnd/imgs/miniaturas/carrito.svg')}}" width="20%" height="20%"> $299.00
                        </div>
                    </div>
                </a>
            </div>
            <div class="col-sm-4">
                <a href="" class="links_cards">
                    <div class="card card_shadow" style="width: 18rem;height: 35rem;">
                        <div class="trapezoid3 "><p style="margin-top: 10%">Comprar</p></div>
                        <img class="card-img-top" src="{{asset('frontEnd/imgs/miniaturas/2.png')}}" alt="Card image cap">
                        <div class="card-body">
                            <h5 class="card-title">UNIDAD ARJUNA</h5>
                            <p class="card-text">Las tropas Arjuna son ideales para controlar de cerca la mesa de juego,
                                aprovechar su Kiranbot sincronizado y poder aprovechar...</p>
        ...
        <div class="row">
            ...
            <div class="col-sm-4">
                <a href="" class="links_cards">
                    <div class="card card_shadow" style="width: 18rem;height: 35rem;">
                        <div class="trapezoid3 "><p style="margin-top: 10%">Comprar</p></div>
                        <img class="card-img-top" src="{{asset('frontEnd/imgs/miniaturas/5.png')}}" alt="Card image cap">
                        <div class="card-body">
                            <h5 class="card-title">UNIDAD ARJUNA</h5>
                            <p class="card-text">Las tropas Arjuna son ideales para controlar de cerca la mesa de juego,
                                aprovechar su Kiranbot sincronizado y poder aprovechar....</p>
    ...
    <div class="header_container">
        ...
        <div class="row">
            ...
            <div class="col-sm-2">
                <a href ="http://www.infinitythegame.com"target="_blank"><img src="{{asset('frontEnd/images/home/corvus.svg')}}" width="100%" height="100%"></a>
            </div>
            <div class="col-sm-2">
                <a href ="http://www.aristeiathegame.com"target="_blank"><img src="{{asset('frontEnd/images/home/aristei.png')}}" width="100%" height="100%"></a>
            </div>
            <div class="col-sm-2">
                <a href ="http://www.modiphius.com"target="_blank"><img src="{{asset('frontEnd/images/home/modifus.png')}}" width="100%" height="100%"></a>
            </div>
            <div class="col-sm-2">
                <a href ="http://www.nosolorol.com"target="_blank"><img src="{{asset('frontEnd/images/home/nosolor.png')}}" width="100%" height="100%"></a>
            </div>
            <div class="col-sm-2">
                <a href ="http://www.siriusdice.com" target="_blank"><img src="{{asset('frontEnd/images/home/sirius.png')}}" width="100%" height="100%"></a>
            </div>
            <div class="col-sm-1"></div>
        </div>
        <div class="row">
