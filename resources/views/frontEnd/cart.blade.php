...
@section('content')
    ...
    <section id="do_action">
        <div class="container">
            <div class="heading">
                <h3>Que deseas hacer ahora?</h3>
                <p>Revisa si tienes algun descuento o cupon disponible.</p>
            </div>
            <div class="row">
                <div class="col-sm-6">
                    ...
                    <div class="chose_area" style="padding: 20px;">
                        <form action="{{url('/apply-coupon')}}" method="post" role="form">
                            ...
                            <div class="form-group">
                                <label for="coupon_code">Codigo del Cupon</label>
                                <div class="controls {{$errors->has('coupon_code')?'has-error':''}}">
                                    <input type="text" class="form-control" name="coupon_code" id="coupon_code" placeholder="Promocion por cupon">
