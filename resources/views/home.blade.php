    ...
    @if ($agent->isMobile())
        ...
        <div class="container_index">
            <div class="row margin_tienda2_mobil">
                <div class="col-sm-12">
                    <div class="contenedor_imagen zoom">
                        <img src="{{asset('frontEnd/images/blogs/1.jpg')}}" width="100%" height="100%">
                        <br>
            ...
            <div class="row margin_tienda2_mobil">
                <div class="col-sm-12">
                    <div class="contenedor_imagen zoom">
                        <img src="{{asset('frontEnd/images/blogs/2.jpg')}}" width="100%" height="100%">
                        <br>
                        <div class="texto-encima">17/Aug/2019</div>
            ...
            <div class="row margin_tienda2_mobil">
                <div class="col-sm-12">
                    <div class="contenedor_imagen zoom">
                        <img src="{{asset('frontEnd/images/blogs/3.jpg')}}" width="100%" height="100%">
                        <br>
                        <div class="texto-encima">17/Aug/2019</div>
            ...
            <div class="row margin_tienda2_mobil">
                <div class="col-sm-12">
                    <div class="contenedor_imagen zoom">
                        <img src="{{asset('frontEnd/images/blogs/4.jpg')}}" width="100%" height="100%">
                        <br>
                        <div class="texto-encima">17/Aug/2019</div>
