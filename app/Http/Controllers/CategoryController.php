...
class CategoryController extends Controller
{
    ...
    public function store(Request $request)
    {
        ...
        return redirect()->route('category.index')->with('message','Agregado con exito!');
    }
    ...
    public function update(Request $request, $id)
    {
        ...
        return redirect()->route('category.index')->with('message','Actualizado con exito!');
    }
    ...
    public function destroy($id)
    {
        ...
        $delete->delete();
        return redirect()->route('category.index')->with('message','Eliminado con exito!');
    }
}
