                        ...
                        <div class ="row">
                            <div class="col-sm-10 col-sm-offset-1">
                                <div class="login-form"><!--login form-->
                                    ...
                                    <legend>Cargo a: </legend>
                                    <div class="form-group {{$errors->has('billing_name')?'has-error':''}}">
                                        <input type="text" class="form-control" name="billing_name" id="billing_name" value="{{$user_login->name}}" placeholder="Name">
                                    ...
                                    <span>
                            <input type="checkbox" class="checkbox" name="checkme" id="checkme"> Enviar a misma direccion de cobro
                        </span>
                                </div><!--/login form-->
                            </div>
                        </div>
